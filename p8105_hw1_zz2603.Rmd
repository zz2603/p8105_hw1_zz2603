...
```{r plot}
ggplot(plot_df, aes(x=x,y=y,color=logic_vtr))+geom_point()

ggplot(plot_df, aes(x=x,y=y,color=logic_num))+geom_point()

ggplot(plot_df, aes(x=x,y=y,color=logic_ftr))+geom_point()
```
